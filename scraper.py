...
def load_inspection_page(**kwargs):
    with open("inspection_page.html", 'r') as li_file:
        html = li_file.read()
        encoding = 'utf-8'
...
def generate_results(test=False, count=10):
    kwargs = {
        u'Inspection_Start': '2/1/2013',
        u'Inspection_End': '2/1/2015',
        u'Zip_Code': '98109'
    }
    if test:
...
def average_sort():
    return features.get('Average Score', None)
